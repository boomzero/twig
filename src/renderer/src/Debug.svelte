                  ...
                  <div class="space-y-4 max-h-96 overflow-y-auto">
                    {#each state.currentSlide.elements as element, index (element.id)}
                      ...
                      >
                        ...
                        <div class="text-xs font-mono space-y-1">
                          <div class="text-gray-500 text-[10px] break-all mb-1">
                            ID: {element.id}
                          </div>
                          ...
                          <div class="grid grid-cols-2 gap-x-4 gap-y-1">
                            <div>
                              ...
                              <span class="text-gray-900">{Math.round(element.x)}</span>
                            </div>
                            <div>
                              <span class="text-gray-600">Y:</span>
                              <span class="text-gray-900">{Math.round(element.y)}</span>
                            </div>
                            <div>
                              <span class="text-gray-600">Width:</span>
                              <span class="text-gray-900">{Math.round(element.width)}</span>
                            </div>
                            <div>
                              <span class="text-gray-600">Height:</span>
                              <span class="text-gray-900">{Math.round(element.height)}</span>
                            </div>
                            <div>
                              <span class="text-gray-600">Angle:</span>
                              <span class="text-gray-900">{element.angle}°</span>
                            </div>
                            {#if element.fill}
                              ...
                              <div class="grid grid-cols-2 gap-x-4 gap-y-1">
                                {#if element.fontSize}
                                  <div>
                                    ...
                                    <span class="text-gray-900">{element.fontSize}px</span>
                                  </div>
                                {/if}
                                {#if element.fontFamily}
                                  <div class="col-span-2">
                                    <span class="text-gray-600">Font:</span>
                                    <span class="text-gray-900">{element.fontFamily}</span>
                                  </div>
                                {/if}
                                {#if element.text}
                                ...
                                {#if element.styles && Object.keys(element.styles).length > 0}
                                  <div class="col-span-2">
                                    ...
                                    <span class="text-gray-900"
                                      >Yes ({Object.keys(element.styles).length} lines)</span
                                    >
                                  </div>
                                {/if}
                              </div>
                            ...
                            <div class="border-t border-gray-200 mt-2 pt-2">
                              {#if element.filename}
                                <div>
                                  ...
                                  <span class="text-gray-900">{element.filename}</span>
                                </div>
                              {/if}
                              {#if element.src}
                                <div>
                                  ...
                                  <span class="text-gray-900"
                                    >{(element.src.length / 1024).toFixed(1)} KB</span
                                  >
                                </div>
                              {/if}
                            </div>
