...
export class AligningGuidelines {
  ...
  /** [twig patch] Subclass hook: extra snap points (e.g. canvas bounds). */
  ...
  scalingOrResizing(e: TransformEvent) {
    ...
    list.push(...this.getExtraSnapPoints(target)); // [twig patch]
  ...
  moving(e: TransformEvent) {
    ...
    points.push(...this.getExtraSnapPoints(target)); // [twig patch]
